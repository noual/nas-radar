...
from search_spaces.dag_search_space.cell import RadarCell, prune_cell
...
class RadarNetwork(nn.Module):
    ...
    def parse(self, actions):
        """
        Given a list of actions, create all cells in the network.
        
        Args:
            actions: List of tuples representing actions to fix architecture.
        """
